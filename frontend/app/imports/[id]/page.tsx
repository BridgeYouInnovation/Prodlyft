...
export default function ImportDetail() {
  ...
  return (
    <Shell active="imports" crumbs={["Acme Co.", "Imports", id.slice(0, 8)]}>
      <div className="flex-1 overflow-auto px-4 md:px-8 py-5 md:py-7 flex flex-col items-center gap-6 md:gap-10">
          ...
          <div className="w-full max-w-[760px]">
            ...
            <div className="card overflow-hidden">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2">
                <div className="p-4 md:p-[22px] border-b md:border-b-0 md:border-r border-line">
                  <div className="text-[11px] text-muted uppercase tracking-wider mb-2">Extracted</div>
                  <div className="text-[18px] md:text-[20px] font-[560] tracking-tight2">{job.result.title ?? "—"}</div>
                ...
                <div className="p-4 md:p-[22px] bg-surface2">
                  {job.result.images?.[0] ? (
              ...
              <div className="px-4 md:px-[22px] py-3 bg-surface2 border-t border-line flex flex-wrap items-center gap-2">
                ...
                <Link href={`/products/${id}`} className="btn-sm btn-primary">
