            ...
            {connected.map((c, i) => (
              <div key={i} className="card p-4">
                <div className="flex items-center gap-2.5">
                  <div className="w-8 h-8 rounded-md relative" style={{ background: c.color, opacity: 0.15 }}>
            ...
            {available.map((a, i) => (
              <div key={i} className="card p-3.5" style={{ opacity: a.soon ? 0.7 : 1 }}>
                <div className="flex items-center gap-2 mb-2.5">
                  <div className="w-[26px] h-[26px] rounded-md relative" style={{ background: a.color, opacity: 0.15 }}>
